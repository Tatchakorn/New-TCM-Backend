...
class AcupunctureArea(models.Model):
    class Meta:
        db_table = 'AcupunctureArea'
    
    part = models.CharField(max_length=64, blank=True, null=True)


class DongAcupunctureArea(models.Model):
    class Meta:
...
class AcupunctureABC(models.Model):
...
class Acupuncture(AcupunctureABC):
